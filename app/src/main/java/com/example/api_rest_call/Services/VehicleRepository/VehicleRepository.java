...
public class VehicleRepository {
    ...
    public void create(Vehicle vehicle, OnSuccess<Void> onSuccessCallback, OnError onErrorCallback) {
        Call<Void> http_call = vehicleHTTPService.createVehicle(vehicle);
